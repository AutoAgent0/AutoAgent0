(() => {
  ...
  const stages = [
    { kicker: 'INDEPENDENT PERCEPTION', title: 'Build a better scene context.', text: 'Camera and LiDAR checks identify disagreements in detected objects. Semantic validation helps assess missed obstacles and unsupported boxes, refining the context supplied to verification and recovery.', image: 'assets/figures/detection.webp', alt: 'Initial detection compared with LiDAR and VLM refinement', chips: ['Camera + LiDAR', 'BridgeDrive', 'Semantic validation'] },
    { kicker: 'SHARED ADMISSION CRITERIA', title: 'Check the proposal before execution.', text: 'A PDMS-based verifier evaluates collision risk, drivable-area compliance, time to collision, lane keeping, and progress. Route-consistency and execution guards complement geometric checks.', image: 'assets/figures/framework.webp', alt: 'Nominal and recovery proposals checked by the shared rule-based verifier', chips: ['Collision', 'Drivable area', 'TTC', 'Progress'] },
    { kicker: 'AGENTIC PARAMETER SEARCH', title: 'Turn a rejection into a new plan.', text: 'When no nominal proposal is admitted, the agent selects an action primitive and bounded parameters. Verifier feedback guides changes in lateral displacement, speed, or duration—or selection of a different primitive.', image: 'assets/figures/recovery.webp', alt: 'Recovery primitive selection and verifier-guided trajectory refinement', chips: ['Brake / creep', 'Lateral bypass', 'Reverse', 'Parameter search'] },
    { kicker: 'OBSERVATION-CONDITIONED ADAPTATION', title: 'Keep recovering in a changing world.', text: 'New observations can motivate a revised maneuver during execution. Each replacement trajectory is verified before commitment. Nominal proposals are reassessed as the runtime works to restore regular driving.', image: 'assets/figures/figma-layout.webp', alt: 'Recovery execution with observation-conditioned adaptation', chips: ['Observe', 'Refine', 'Verify again', 'Return to nominal'] }
  ];
