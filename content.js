...
window.AUTOAGENT = {
  ...
  scenarios: [
    { id: 'blocked-road', label: 'Blocked road', title: 'Finding a way forward when the nominal path fails', description: 'A blocked route calls for more than a change in speed. The runtime can propose an alternative maneuver, refine its parameters, and verify the new trajectory before execution.', videos: { expert: '', monitor: '', ours: '' } },
    { id: 'bad-parking', label: 'Bad parking', title: 'Recovering around an obstructed lane', description: 'Irregularly parked vehicles challenge the nominal trajectory. Scene refinement and parameterized lateral bypass provide an alternative that remains subject to the shared verifier.', videos: { expert: '', monitor: '', ours: '' } },
    { id: 'construction-pedestrians', label: 'Construction & pedestrians', title: 'Reasoning about obstacles and vulnerable road users', description: 'Construction changes the drivable corridor while pedestrians introduce dynamic constraints. Updated scene context informs both admission checks and recovery planning.', videos: { expert: '', monitor: '', ours: '' } },
